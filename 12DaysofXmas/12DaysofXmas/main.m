...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        // Iteratating through 12 times to repeat the song
        for (int i = 0; i < [days count]; i++){
            
            if (i == 0){
                NSLog("On the %@ day of Christmas, my true love game to me \n", [days objectAtIndex:i]);
            }
            
            else {
    
                for (int j = i; j >= 0; j--){
                    NSLog(@"For the %@ day of Christmas, my true love gave to me \n ", [days objectAtIndex:i]);
                }
